  ...
  <div class="d-flex p-2 bd-highlight justify-content-center">
    <form action="modify" method="post">
      <div class="form-group row">
        ...
        <div class="col-sm-5">
          <input type="text" class="form-control form-control-sm" id="nombre" name="nombre" value="<% if (usuario.getNombre() != null) out.print(usuario.getNombre()); else out.print("Nombre"); %>">
        </div>
      </div>
      <div class="form-group row">
        ...
        <div class="col-sm-5">
          <input type="text" class="form-control form-control-sm" id="apellidos" name="apellidos"
            value="<% if (usuario.getApellidos() != null) out.print(usuario.getApellidos()); else out.print("Apellidos");%>">
        </div>
      </div>
      <div class="form-group row">
        <label for="colFormLabelSm" class="col-sm-2 col-form-label col-form-label-sm">Correo electrónico</label>
        <div class="col-sm-5">
          <input type="mail" class="form-control form-control-sm" id="mail" name="mail" value="<% if (usuario.getMail() != null) out.print(usuario.getMail()); else out.print("Mail"); %>" >
        </div>
      </div>
      <div class="form-group row">
        <label for="colFormLabelSm" class="col-sm-2 col-form-label col-form-label-sm">Clave</label>
        <div class="col-sm-5">
          <input type="password" class="form-control form-control-sm" id="clave" name="clave" value="<% if (usuario.getClave() != null) out.print(usuario.getClave()) ; else out.print("1234"); %>">
        </div>
      </div>
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control form-control-sm" id="tarjeta" name="tarjeta"
            value="<% if (usuario.getTarjeta() != null) out.print(usuario.getTarjeta()) ; else out.print("000000000000"); %>">
        </div>
      </div>
      <div class="form-group row">
